...
mypathmax <- file.path("G:","sampleScripts","New Folder","filtered",paste("WNBfltdata_",t,".txt", sep = ""))
...
weightpath <- file.path("G:","sampleScripts","New Folder","EPLweights",paste("02Dilfilteredwts", i, sep = ""))
...
# node betweenness
mypathWBC <- file.path("G:","sampleScripts","New Folder","filtered",paste("WNBfltdata_",i,".txt", sep = ""))
...
mypathsave <- file.path("G:","sampleScripts","New Folder","filtered","WNB filtered plots",paste("WBCflt_", i, ".png", sep = ""))
